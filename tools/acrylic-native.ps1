...
#
#  Reele usa esto SOLO para el modo 'acrylic-always'. El acrilico del
...
if (-not ("ReeleAcrylic" -as [type])) {
    Add-Type -Language CSharp @"
using System;
using System.Runtime.InteropServices;

public static class ReeleAcrylic {
...
# cruzados y el violeta aparece verde.
...
$n = [ReeleAcrylic]::Apply([uint32]$TargetPid, $state, [uint32]$gradient, $backdropType, $reset)
