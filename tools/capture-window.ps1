# ============================================================
#  Captura la ventana de Reele para poder MIRAR el resultado.
#
...
#
#  USO:
#    powershell -NoProfile -File capture-window.ps1 -TitleLike 'Reele' -Out captura.png
# ============================================================

param(
    [string]$TitleLike = 'Reele',
