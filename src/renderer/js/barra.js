 ...
 * descargado y lo ya visto) mas un globo con el tiempo bajo el cursor, y el
 * range nativo solo deja pintar uno. A cambio hay que resolver a mano la
 * captura del puntero y el teclado, que es lo que hace esto.
 *
...
export function crearBarra(raiz, opciones = {}) {
  ...
  raiz.addEventListener('keydown', (evento) => {
    ...
    evento.preventDefault();
    // Se para aqui: si sube, los atajos globales veran la misma flecha y
    // saltarian ademas diez segundos en el video.
